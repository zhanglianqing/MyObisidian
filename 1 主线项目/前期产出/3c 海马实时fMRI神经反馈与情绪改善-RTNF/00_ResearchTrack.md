...
| **下一步** | A+B+D 叙事下 §3 改稿 → [[改稿记录/202605-Storyline-ABD-定稿框架]] · ⏳ [[2026-06-01 科研推进#3.2 · RTNF]] 2026-06-06 |
| **文献 S0** | ✅ 46 条在 Zotero + bib；内化队列 → [[7 可复用知识库/_migration/RTNF-引文与内化队列]] |
| **文献 S1** | 5 篇（#13/#15/#16/#20/#24，2026-06-04）→ [[7 可复用知识库/_migration/RTNF-引文与内化队列]] |
| **改稿台账** | [[改稿记录/202605-姚老师-R01-批注处理清单]] |
| 主稿入库 | vault `定稿/manuscript_RTNF.docx` 仍为 0522 快照；**发回定稿后**再覆盖 + rerun digest |
| 版本 | 坚果云留档 + Word 比较；不建 Git → [[定稿/README#改稿版本约定（坚果云 · 不建 Git）]] |
...
- [x] 主稿 **46 条** 引文迁入 Zotero（2026-06-04）
- [ ] 文献内化 / DOI 核对 → [[7 可复用知识库/_migration/RTNF-引文与内化队列]] 🔽
